    ...
    <Layout>
      ...
      <div className="site-block-wrap">
        <div className="owl-carousel with-dots">
          <div
            className="site-blocks-cover overlay overlay-2 bg-home"
            data-aos="fade"
            id="home-section"
          >
              ...
              <div className="row align-items-center justify-content-center">
                <div className="col-md-12 mt-lg-5 text-center">
                  <h1 className="text-shadow">
                    Search &amp; Find All COVID-19 Details Here
                  </h1>
        ...
        <div className="container">
          <div className="row large-gutters">
            ...
            <div className="col-lg-6 ml-auto">
              <h2 className="section-title text-capitalize mb-3">
                Watin be Corona Sef?
              </h2>
              <p>
                ALorem ipsum dolor sit amet, consectetur adipiscing elit.
                Maecenas id rutrum turpis, blandit vestibulum nulla. Vivamus a
                est vel mauris dignissim porttitor. Vestibulum nisl lorem,
                bibendum eget risus at, iaculis blandit diam. Curabitur sagittis
                tincidunt hendrerit. Mauris convallis accumsan mauris, vel
                vestibulum erat. Phasellus viverra dui eu nisl accumsan
                suscipit. Donec ligula nisl, malesuada ut dapibus ut, commodo a
                nulla
              </p>
        ...
        <div class="container">
          <div class="row mb-5">
            <div class="col-12 text-center">
              <h2 class="section-title mb-3">
                Watin you need to know about corona virus (COVID-19)
              </h2>
            </div>
          </div>
          <div class="row align-items-stretch">
            ...
            >
              <div class="unit-4 d-flex">
                <div class="unit-4-icon mr-4">
                  <span class="text-primary flaticon-coin"></span>
                </div>
                <div>
                  <h3>Buy Property</h3>
                  <p>
            ...
            >
              <div class="unit-4 d-flex">
                <div class="unit-4-icon mr-4">
                  <span class="text-primary flaticon-location"></span>
                </div>
                <div>
            ...
            >
              <div class="unit-4 d-flex">
                <div class="unit-4-icon mr-4">
                  <span class="text-primary flaticon-mobile-phone"></span>
                </div>
                <div>
                  <h3>Mobile Apps</h3>
                  <p>
      ...
      <section class="site-section" id="news-section">
        <div class="container">
          <div class="row mb-5">
            <div class="col-12 ">
              <h2 class="section-title text-center text-captalize mb-3">
                How you go fit take protect yourself from corona{" "}
              </h2>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
              <Link to="">
                <div class="h-entry">
                  <div>
                    <h4 className="p-2">Helpful Tips</h4>
                  </div>
                  <ul>
                    <li className="cor__step"> Wash your hands frequently</li>
                    <li className="cor__step"> Maintain social distancing</li>
                    <li className="cor__step">
                      {" "}
                      Avoid touching eyes, nose and mouth
                    </li>
                    <li className="cor__step"> Practise respiratory hygiene</li>
                    <li className="cor__step">
                      {" "}
                      If you have fever, cough and difficulty breathing, seek medical help early
                    </li>
                  </ul>
                  <div class="meta mb-4"></div>
                </div>
              </Link>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
              <Link to>
                <div class="h-entry">
                  <div>
                    <h4>Report any suspected case</h4>
                  </div>

                  <p class="font-size-regular">
                    <Link to class="text-dark">
                      Article Communicating with the public during health
                      crises: experts' experiences and opinions during health
                      crises: experts' experiences and opinions
                    </Link>
                  </p>
                  <div class="meta  text-center mt-4">
                    <button className="btn btn-primary">Report case</button>
                  </div>
                </div>
              </Link>
            </div>
